package org.myaccounts.common.config;
...
public class OpenAPIConfiguration {
	...
	OpenAPI defineOpenApi() {
		...
		Info information = new Info().title("My Accounts API").version("1.0")
				.description("This API exposes endpoints for myaccounts api.").contact(myContact)
